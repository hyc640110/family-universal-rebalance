...
export function normalizeState(raw: unknown): AppState {
  ...
  return { ...normalizedCore, wealthGoal: normalizeWealthGoalSettings(s.wealthGoal), ...(cashFlowProfile ? { cashFlowProfile } : {}), ...(retirementPlan ? { retirementPlan } : {}), ...(netWorthHistory ? { netWorthHistory } : {}), fxRateHistory, syncMeta: sanitizeSyncMeta(s.syncMeta, normalizedCore) };
}
