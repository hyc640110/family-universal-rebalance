...
// `linkedAccountId` is optional and only offered against existing `creditCard`-type accounts;
// it is display/context metadata only (which real account this reminder relates to) and is
