...
function derivedHoldings(state: AppState): Holding[] {
  ...
  [...state.trades].reverse().forEach(t => {
    const h = map[t.symbol] ||= { symbol: t.symbol, shares: 0, avgCost: 0, targetWeight: 0, cost: 0 };
