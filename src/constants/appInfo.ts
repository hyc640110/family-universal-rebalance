...
const environmentBoundary = createEnvironmentBoundary(import.meta.env.VITE_DEPLOYMENT_ENVIRONMENT, import.meta.env.VITE_DEPLOYMENT_SCOPE);
...
export const DEPLOYMENT_SCOPE = environmentBoundary.deploymentScope;
