...
test('P3-B2-B keeps JSON Backup legacy read compatibility without re-exporting Firebase config', () => {
  assert.match(app, /syncSettings: \{ refreshSec: normalized\.refreshSec, autoSync: normalized\.autoSync, autoSyncSec: normalized\.autoSyncSec, workerUrl: DEFAULT_WORKER_URL \}/);
