...
Generated UTC: 2026-08-16T12:38:50.714869+00:00
...
- `003_CURRENT_STATUS.md` — SHA-256 `7d8c47772a6551d52e3ab662f9b4267f048b38b093a5b8485603c64d389d6b2b`
...
- `008_TODO_BACKLOG.md` — SHA-256 `59632bf424f1775b101dddf7b6238b34437e342d82d6461a6a743e472d31cb20`
...
- `012_AI_HANDOVER.md` — SHA-256 `993c783b839ea71e540d7cf217d00b7f7b6202d73df4ebe4675e4c5455f26d4c`
...
**UR-TODO-069（退休規劃固定支出卡片精簡＋刪除圖示防誤觸）正在同一 Todo 的手機版 follow-up Development Mode。** PR [#372](https://github.com/hyc640110/family-universal-rebalance/pull/372) 已 Merge，現行正式起點為 `origin/main` `87777766f9e2c37bcae0bad35194cc20444ab67a`；獨立 branch `codex/ur-todo-069-mobile-expense-toolbar` 僅修正 `/tools/retirement-planner` 固定支出卡片在 390px 下的「計入支出」文字換行。唯讀實機量測確認原工具列已是橫列且垃圾桶為 44×44px、無水平溢出，但勾選標籤被壓縮為約 66px／81px 高而將完整文字換行；本 follow-up 僅於 `max-width:768px` 加入 `white-space: nowrap`，保留完整可存取文案與既有原生 `<label>` 語意。桌機、JSX、刪除確認／`removeItem()`、Cash Flow 與 `retirementPlan` 資料邏輯均不變。待 CI 與 Preview 驗收後，使用者再決定是否 Merge。
...
- 範圍：
  ...
  5. 手機版 follow-up 僅在 `max-width:768px` 禁止完整「計入支出」文字換行；桌機布局與文字均維持原樣。
