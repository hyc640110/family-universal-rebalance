...
Generated UTC: 2026-08-08T02:23:15.870866+00:00
...
- `003_CURRENT_STATUS.md` — SHA-256 `6af48ea702f4ead0f8b2c4713e66d62ddc9dbca6abf405b6d5c7bd0a9134c22b`
...
- `008_TODO_BACKLOG.md` — SHA-256 `f45ae1ebec9eac620945bd6e33baa864ff4deae4c4a81163b87d3fd58d35f7e1`
...
2026-08-08 更新：**UR-TODO-046 C1、046-B、046-C1／C2、046-C3A、046-C3B、046-C3C-A、046-C3C-B、046-C3C-C 與 Firebase Ledger Sync 已完成，但 UR-TODO-046 整體仍未完成**。後續撤銷／void、split allocation、investment buy／sell attribution、loan principal／interest attribution、FX attribution 等仍需獨立排程與產品決策（皆屬重大事件），詳見下方「Remaining Boundaries」。
...
- **Remaining Boundaries（Firebase Ledger Sync 完成後更新）**：
...
- **下一正式候選（待盤點，未開始）**：撤銷／void、split allocation、investment buy／sell attribution、loan principal／interest attribution、FX attribution，或其他最新治理文件已定義項目，需依最新 Repository／AI_CONTEXT 另行唯讀判斷。**若下一候選涉及 Ledger 寫入語意變更、schema／persistence 結構性變更或核心 attribution 結果改變、AI Decision／Rebalance 接線，屬重大產品／核心財務語意事件，須另行拍板，不得自動開始。** UR-TODO-046 整體維持「部分完成／後續待評估」，不得因 Firebase Ledger Sync 完成而自行標記整體已完成——撤銷／void 屬於本 Todo 從 C1 階段即持續記錄、尚未排程的既有已知缺口，非新發現。
