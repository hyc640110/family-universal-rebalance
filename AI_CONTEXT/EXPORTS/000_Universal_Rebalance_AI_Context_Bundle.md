...
Generated UTC: 2026-08-13T16:32:52.688594+00:00
...
- `003_CURRENT_STATUS.md` — SHA-256 `cdb4aa0699f1894334d4c1c1cbbdc80d4cc186669081fc64f8d015d1cb485da4`
...
- `008_TODO_BACKLOG.md` — SHA-256 `c8fa6fa6f8450d65ec909a2b915a708f35d8177198c3485ce46db0e102d22ee1`
- `009_CHANGELOG.md` — SHA-256 `12660202662597c0cbd4d60ecfe0e20da5f7379d4e69491e9ff1941232f831ee`
...
- `012_AI_HANDOVER.md` — SHA-256 `55064abe6ec82649c78b5922477477551451609cd2547f198f4e77db8a973a49`
...
- `020_Architecture_Decisions.md` — SHA-256 `4e1f10d1970bbd6902dd47e05753a06160d42ee7572b379b5926a57f6d8f13e0`
...
# Universal Rebalance Current Status v4.00
...
## 最新交接快照：UR-TODO-046 FX-F2C-2 Manual FX Conversion Producer（開發完成／Draft PR 待架構與 Preview-enable 前審查，2026-08-14）
...
- 下一直接起點：Draft PR 待 CI／diff／架構與 Preview-enable 前審查。**F2C-2 建立了完整的 Producer 程式碼與雙層 gate（UI＋write path），但 Production／Preview 目前皆仍無法真正建立 FX conversion；即使技術上 source gate 翻成 `true` 只會讓 Preview 具備 capability、Production 仍恆為 OFF（ADR-010 既有設計），翻轉 source gate 本身仍必須是另一個獨立、明確授權、單獨審查的 PR，不得因本 Sprint 完成而自動視為已解鎖。** UR-TODO-046 整體仍 OPEN；**不得自行 Merge、Ready for review 或部署 Production**；PR #322（Loan audit）為獨立 Draft／OPEN，本次未處理。
