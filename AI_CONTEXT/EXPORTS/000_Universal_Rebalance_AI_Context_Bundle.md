...
Generated UTC: 2026-08-14T00:56:57.818242+00:00
...
- `003_CURRENT_STATUS.md` — SHA-256 `2a67fb9b7b10eb1de6a07d1ca915b8583e67a39287f9e4430c5727273173036e`
...
- `008_TODO_BACKLOG.md` — SHA-256 `891b4f3b4754a109e850e2af79ee45ee7ea41fea53f022b5e6b7caa0f0d5b6cc`
- `009_CHANGELOG.md` — SHA-256 `9936465b3ffd889d9d15906fdc310754fe55c5fb453af35ef796b62f70d37e63`
...
- `012_AI_HANDOVER.md` — SHA-256 `c69748ceacc3bee6d473b6b7882b254316b3f0253d89d26378e16abe7764306d`
...
- `020_Architecture_Decisions.md` — SHA-256 `b3ed7a26a11329f1fa37e6d5e3ce6d6a2503b8ff17d23bb17730b8669ef21813`
...
# Universal Rebalance Current Status v4.01
...
# Universal Rebalance Todo Backlog v1.78
...
## 最新交接快照：UR-TODO-046 FX-F2C-3 Preview Producer Enable（開發完成／Draft PR 待 Preview 驗收與 Merge Gate 審查，2026-08-14）
...
- 下一直接起點：Draft PR（`feat/ur-todo-046-fx-f2c3-preview-enable`）待 CI／正式 GitHub Pages Preview 部署（`workflow_dispatch`）／使用者於正式 Preview 環境驗收／Merge Gate 審查。**本 Sprint 只是把 source gate 從 `false` 翻成 `true`，Preview 因此第一次具備真正建立 FX conversion 的 capability，Production 依既有 environment guard 恆為 OFF；這不代表 Production unlock 已授權，也不代表 F2D（`fxConversionAttribution`／`FinancialEvent` FX 接線）已開始。** UR-TODO-046 整體仍 OPEN；**不得自行 Merge、Ready for review 或部署 Production**；PR #322（Loan audit）為獨立 Draft／OPEN，本次未處理。
